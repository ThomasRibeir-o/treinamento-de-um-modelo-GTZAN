        ...
        return [
            {
                ...
                "clf__C": [0.1, 5, 10],#entortamento de reta
                "clf__kernel": ["rbf", "poly"],#tirei o poly
                "clf__gamma": ["scale"],
                "scaler": scalers,
            },
            # {
            ...
            #     "clf__n_neighbors": [3, 5, 7, 9, 11],#numero de vizinhos, nao colocar par pois pode empatar e dar ruim# antes estava"clf__n"
            ...
            #     "clf__learning_rate_init":[0.008],#velocidade que ele aprende
            #     "scaler": scalers,
            # }
