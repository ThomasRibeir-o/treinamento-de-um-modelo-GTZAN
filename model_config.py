    ...
    def get_grid():
        ...
        return [
            ...
            },
            {
                ...
                "clf__C": [0.1, 1, 5, 10, 50, 100],#entortamento de reta
                "clf__max_iter": [1500],# bastante, mas cuidado com o overfeeting
                "scaler": scalers,
            },
            {
                "clf": [KNeighborsClassifier()],
                "clf__n": [3, 5, 7, 11, 13, 17],#numero de vizinhos, nao colocar par pois pode empatar e dar ruim
                "clf__weights": ['uniform', 'distance'],
                "scaler": scalers,
            },
            {
                "clf": [RandomForestClassifier(random_state=89, class_weight="balanced")],
                "clf__max_depth":[None, 10, 20, 30],#none: os nós expandem ate onde achar mlr
            ...
            },
            {
                ...
                "clf__learning_rate_init":[0.0001],#velocidade que ele aprende
                "scaler": scalers,
            }
